...
- On the mobile homepage, keep the shared sticky name and theme toggle at the same top offset as case routes and `/all` while Links/Contact follows the table. Use native document scrolling so keyboard, screen-reader, and touch access traverse the complete page.
