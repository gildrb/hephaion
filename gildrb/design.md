...
- On the mobile homepage, keep the name and theme toggle in the normal page flow and let Links/Contact follow the table. Use native document scrolling so keyboard, screen-reader, and touch access traverse the complete page.
